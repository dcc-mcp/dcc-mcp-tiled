...
Install a supported Tiled release or set `DCC_MCP_TILED_EXECUTABLE` to its exact
executable. On macOS, point inside `Tiled.app`; on Linux AppImage installs, make
the exact verified file executable.
